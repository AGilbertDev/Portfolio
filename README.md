...
<p>Form validation is all done via PHP for added security, because it's easy for users to modify html code in order to remove Javascript form validation and send whatever they want.</p>
<p>To prevent code injection inside the form, the program transforms each user input into html entities before processing it.</p>
